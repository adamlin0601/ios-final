//
//  MaintainTableViewController.swift
//  final project1
//
...
class MaintainTableViewController: UITableViewController {
    ...
    func pickUpDate(_ textField : UITextField){
        ...
        let doneButton = UIBarButtonItem(title: "Done", style: .plain, target: self, action: #selector(MaintainTableViewController.doneClick))
